...
ActiveRecord::Schema.define(version: 20180810155224) do
  ...
  create_table "engagement_companies", force: :cascade do |t|
    t.integer "company_id"
    t.integer "deal_id"
  end

  create_table "engagement_sponsors", force: :cascade do |t|
    t.integer "sponsor_id"
    t.integer "deal_id"
  end
